    ...
    void actualizarCantidad_exito() throws Exception {
        ...
        InventarioResponseDTO response = InventarioResponseDTO.builder()
                .data(InventarioResponseDTO.Data.builder()
                        .type("inventario")
                        .id("1")
                        .attributes(InventarioResponseDTO.Attributes.builder().productoId(1L).cantidad(20).build())
                        .build())
                .build();
        Mockito.when(inventarioService.actualizarCantidad(any(Long.class), any(InventarioRequestDTO.class))).thenReturn(response);
    ...
    void realizarCompra_exito() throws Exception {
        CompraRequestDTO request = CompraRequestDTO.builder()
                .data(CompraRequestDTO.Data.builder()
                        .type("compras")
                        .attributes(CompraRequestDTO.Attributes.builder().productoId(1L).cantidad(2).build())
                        .build())
                .build();
        CompraResponseDTO response = CompraResponseDTO.builder()
                .data(CompraResponseDTO.Data.builder()
                        ...
                        .attributes(CompraResponseDTO.Attributes.builder().productoId(1L).cantidad(2).cantidadRestante(8).nombreProducto("Test").precioTotal(200.0).build())
                        .build())
                .build();
